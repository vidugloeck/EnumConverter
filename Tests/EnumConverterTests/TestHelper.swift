...
//  EnumConverterTests
//
//  Created by Vidu Glöck on 06.06.21.
//

import Foundation
import XCTest

public func assertEqual(expected: String, actual: String, file: StaticString = #file, line: UInt = #line) {
    if expected != actual {
        let diff =
...
// Credit: https://github.com/pointfreeco/swift-composable-architecture
